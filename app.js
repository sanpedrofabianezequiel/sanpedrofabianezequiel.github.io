...
presupesto.addEventListener('click',(e) => { location.href= "https://sanpedrofabianezequiel.github.io/australia/"; console.log(presupesto)})

var compentencia= document.querySelector("#compentencia")
compentencia.addEventListener('click',(e) => { location.href= "https://www.codeandvisual.com.au/package/landing-page"; console.log(compentencia)})
...
whatsaap.addEventListener('click',(e)=>{  location.href="https://wa.link/9mutai"})
